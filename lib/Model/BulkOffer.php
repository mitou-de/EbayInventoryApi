...
class BulkOffer implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'requests' => '\EbayInventoryApi\Model\OfferKeyWithId[]'
    ];
     ...
     * Sets requests
     *
     * @param \EbayInventoryApi\Model\OfferKeyWithId[]|null $requests This container is used to pass in an array of offers to publish. Up to 25 offers can be published with one bulkPublishOffer method.
     *
     * @return $this
     */
