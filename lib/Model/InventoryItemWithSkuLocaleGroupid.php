...
class InventoryItemWithSkuLocaleGroupid implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'availability' => '\EbayInventoryApi\Model\Availability',
        'condition' => 'string',
        'condition_description' => 'string',
        'group_ids' => 'string[]',
        'inventory_item_group_keys' => 'string[]',
        'locale' => 'string',
        'package_weight_and_size' => '\EbayInventoryApi\Model\PackageWeightAndSize',
        'product' => '\EbayInventoryApi\Model\Product',
        'sku' => 'string'
    ];
     ...
     * Gets availability
     *
     * @return \EbayInventoryApi\Model\Availability|null
     */
     ...
     * Sets availability
     *
     * @param \EbayInventoryApi\Model\Availability|null $availability availability
     *
     * @return $this
     */
     ...
     * Sets locale
     *
     * @param string|null $locale This field is for future use only. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/inventory/types/LocaleEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     *
     * @return \EbayInventoryApi\Model\PackageWeightAndSize|null
     */
     ...
     *
     * @param \EbayInventoryApi\Model\PackageWeightAndSize|null $package_weight_and_size package_weight_and_size
     *
     * @return $this
     */
     ...
     * Gets product
     *
     * @return \EbayInventoryApi\Model\Product|null
     */
     ...
     * Sets product
     *
     * @param \EbayInventoryApi\Model\Product|null $product product
     *
     * @return $this
     */
