...
class OfferResponseWithListingId implements ModelInterface, ArrayAccess
{
     ...
     * Sets errors
     *
     * @param \EbayInventoryApi\Model\Error[]|null $errors This container will be returned if there were one or more errors associated with publishing the offer.
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param \EbayInventoryApi\Model\Error[]|null $warnings This container will be returned if there were one or more warnings associated with publishing the offer.
     *
     * @return $this
     */
