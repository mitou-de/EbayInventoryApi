...
class MigrateListingResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'errors' => '\EbayInventoryApi\Model\Error[]',
        'inventory_item_group_key' => 'string',
        'inventory_items' => '\EbayInventoryApi\Model\InventoryItemListing[]',
        'listing_id' => 'string',
     ...
     * Sets errors
     *
     * @param \EbayInventoryApi\Model\Error[]|null $errors If one or more errors occur with the attempt to migrate the listing, this container will be returned with detailed information on each error.
     *
     * @return $this
     */
     ...
     *
     * @return \EbayInventoryApi\Model\InventoryItemListing[]|null
     */
     ...
     *
     * @param \EbayInventoryApi\Model\InventoryItemListing[]|null $inventory_items This container exists of an array of SKU values and offer IDs. For single-variation listings, this will only be one SKU value and one offer ID (if listing was successfully migrated), but multiple SKU values and offer IDs will be returned for multiple-variation listings.
     *
     * @return $this
     */
     ...
     * Sets marketplace_id
     *
     * @param string|null $marketplace_id This is the unique identifier of the eBay Marketplace where the listing resides. The value fo the eBay US site will be EBAY_US. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/inventory/types/MarketplaceEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param \EbayInventoryApi\Model\Error[]|null $warnings If one or more warnings occur with the attempt to migrate the listing, this container will be returned with detailed information on each warning. It is possible that a listing can be successfully migrated even if a warning occurs.
     *
     * @return $this
     */
