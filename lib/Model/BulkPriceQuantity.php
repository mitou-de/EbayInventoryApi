...
class BulkPriceQuantity implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'requests' => '\EbayInventoryApi\Model\PriceQuantity[]'
    ];
     ...
     * Gets requests
     *
     * @return \EbayInventoryApi\Model\PriceQuantity[]|null
     */
     ...
     * Sets requests
     *
     * @param \EbayInventoryApi\Model\PriceQuantity[]|null $requests This container is used by the seller to update the total 'ship-to-home' quantity of one or more inventory items (up to 25) and/or to update the price and/or quantity of one or more specific published offers.
     *
     * @return $this
     */
