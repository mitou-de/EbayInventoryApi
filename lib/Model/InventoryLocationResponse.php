...
class InventoryLocationResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'location' => '\EbayInventoryApi\Model\Location',
     ...
     * Gets location
     *
     * @return \EbayInventoryApi\Model\Location|null
     */
     ...
     * Sets location
     *
     * @param \EbayInventoryApi\Model\Location|null $location location
     *
     * @return $this
     */
     ...
     *
     * @param \EbayInventoryApi\Model\OperatingHours[]|null $operating_hours This container shows the regular operating hours for a store location during the days of the week. A dayOfWeekEnum field and an intervals container is shown for each day of the week that the store location is open.
     *
     * @return $this
     */
     ...
     * Sets special_hours
     *
     * @param \EbayInventoryApi\Model\SpecialHours[]|null $special_hours This container shows the special operating hours for a store location on a specific date or dates.
     *
     * @return $this
     */
