...
class LocationApi
{
     ...
     * @param  \EbayInventoryApi\Model\InventoryLocationFull $inventory_location_full Inventory Location details (required)
     *
     ...
     */
    protected function createInventoryLocationRequest($merchant_location_key, $inventory_location_full)
    {
        ...
        if (isset($inventory_location_full)) {
            $_tempBody = $inventory_location_full;
        }
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayInventoryApi\Model\InventoryLocationResponse
     */
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayInventoryApi\Model\InventoryLocationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInventoryLocationWithHttpInfo($merchant_location_key)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayInventoryApi\Model\InventoryLocationResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayInventoryApi\Model\InventoryLocationResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayInventoryApi\Model\InventoryLocationResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayInventoryApi\Model\InventoryLocationResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayInventoryApi\Model\LocationResponse
     */
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayInventoryApi\Model\LocationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInventoryLocationsWithHttpInfo($limit = null, $offset = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayInventoryApi\Model\LocationResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayInventoryApi\Model\LocationResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayInventoryApi\Model\LocationResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayInventoryApi\Model\LocationResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \EbayInventoryApi\Model\InventoryLocation $inventory_location The inventory location details to be updated (other than the address and geo co-ordinates). (required)
     *
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateInventoryLocationRequest($merchant_location_key, $inventory_location)
    {
        // verify the required parameter 'merchant_location_key' is set
        if ($merchant_location_key === null || (is_array($merchant_location_key) && count($merchant_location_key) === 0)) {
            throw new \InvalidArgumentException(
