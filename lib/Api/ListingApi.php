...
class ListingApi
{
     ...
     *
     * @param  \EbayInventoryApi\Model\BulkMigrateListing $bulk_migrate_listing Details of the listings that needs to be migrated into Inventory (required)
     *
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayInventoryApi\Model\BulkMigrateListingResponse
     */
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayInventoryApi\Model\BulkMigrateListingResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function bulkMigrateListingWithHttpInfo($bulk_migrate_listing)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayInventoryApi\Model\BulkMigrateListingResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayInventoryApi\Model\BulkMigrateListingResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayInventoryApi\Model\BulkMigrateListingResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayInventoryApi\Model\BulkMigrateListingResponse',
     ...
     */
    protected function bulkMigrateListingRequest($bulk_migrate_listing)
    {
        ...
        if (isset($bulk_migrate_listing)) {
            $_tempBody = $bulk_migrate_listing;
        }
