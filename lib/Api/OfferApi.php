...
class OfferApi
{
     ...
     *
     * @param  \EbayInventoryApi\Model\BulkEbayOfferDetailsWithKeys $bulk_ebay_offer_details_with_keys Details of the offer for the channel (required)
     *
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayInventoryApi\Model\BulkOfferResponse
     */
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayInventoryApi\Model\BulkOfferResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function bulkCreateOfferWithHttpInfo($bulk_ebay_offer_details_with_keys)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayInventoryApi\Model\BulkOfferResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayInventoryApi\Model\BulkOfferResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayInventoryApi\Model\BulkOfferResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayInventoryApi\Model\BulkOfferResponse',
     ...
     */
    protected function bulkCreateOfferRequest($bulk_ebay_offer_details_with_keys)
    {
        ...
        if (isset($bulk_ebay_offer_details_with_keys)) {
            $_tempBody = $bulk_ebay_offer_details_with_keys;
        }
     ...
     *
     * @param  \EbayInventoryApi\Model\BulkOffer $bulk_offer The base request of the bulkPublishOffer method. (required)
     *
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayInventoryApi\Model\BulkPublishResponse
     */
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayInventoryApi\Model\BulkPublishResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function bulkPublishOfferWithHttpInfo($bulk_offer)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayInventoryApi\Model\BulkPublishResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayInventoryApi\Model\BulkPublishResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayInventoryApi\Model\BulkPublishResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayInventoryApi\Model\BulkPublishResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function bulkPublishOfferRequest($bulk_offer)
    {
     ...
     * @param  \EbayInventoryApi\Model\EbayOfferDetailsWithKeys $ebay_offer_details_with_keys Details of the offer for the channel (required)
     *
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayInventoryApi\Model\OfferResponse
     */
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayInventoryApi\Model\OfferResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createOfferWithHttpInfo($content_language, $ebay_offer_details_with_keys)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\EbayInventoryApi\Model\OfferResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayInventoryApi\Model\OfferResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayInventoryApi\Model\OfferResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayInventoryApi\Model\OfferResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createOfferRequest($content_language, $ebay_offer_details_with_keys)
    {
        ...
        if (isset($ebay_offer_details_with_keys)) {
            $_tempBody = $ebay_offer_details_with_keys;
        }
     ...
     *
     * @param  \EbayInventoryApi\Model\OfferKeysWithId $offer_keys_with_id List of offers that needs fee information (optional)
     *
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayInventoryApi\Model\FeesSummaryResponse
     */
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayInventoryApi\Model\FeesSummaryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListingFeesWithHttpInfo($offer_keys_with_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayInventoryApi\Model\FeesSummaryResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayInventoryApi\Model\FeesSummaryResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayInventoryApi\Model\FeesSummaryResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayInventoryApi\Model\FeesSummaryResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getListingFeesRequest($offer_keys_with_id = null)
    {
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayInventoryApi\Model\EbayOfferDetailsWithAll
     */
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayInventoryApi\Model\EbayOfferDetailsWithAll, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOfferWithHttpInfo($offer_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayInventoryApi\Model\EbayOfferDetailsWithAll' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayInventoryApi\Model\EbayOfferDetailsWithAll', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayInventoryApi\Model\EbayOfferDetailsWithAll';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayInventoryApi\Model\EbayOfferDetailsWithAll',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayInventoryApi\Model\Offers
     */
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayInventoryApi\Model\Offers, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOffersWithHttpInfo($sku = null, $marketplace_id = null, $format = null, $limit = null, $offset = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayInventoryApi\Model\Offers' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayInventoryApi\Model\Offers', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayInventoryApi\Model\Offers';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayInventoryApi\Model\PublishResponse
     */
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayInventoryApi\Model\PublishResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function publishOfferWithHttpInfo($offer_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayInventoryApi\Model\PublishResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayInventoryApi\Model\PublishResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayInventoryApi\Model\PublishResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayInventoryApi\Model\PublishResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \EbayInventoryApi\Model\PublishByInventoryItemGroupRequest $publish_by_inventory_item_group_request The identifier of the inventory item group to publish and the eBay marketplace where the listing will be published is needed in the request payload. (required)
     *
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayInventoryApi\Model\PublishResponse
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function publishOfferByInventoryItemGroupRequest($publish_by_inventory_item_group_request)
    {
        ...
        if (isset($publish_by_inventory_item_group_request)) {
            $_tempBody = $publish_by_inventory_item_group_request;
        }
     ...
     * @param  string $content_language This request header sets the natural language that will be provided in the field values of the request payload. (required)
     * @param  \EbayInventoryApi\Model\EbayOfferDetailsWithId $ebay_offer_details_with_id Details of the offer for the channel (required)
     *
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayInventoryApi\Model\OfferResponse
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateOfferRequest($offer_id, $content_language, $ebay_offer_details_with_id)
    {
        // verify the required parameter 'offer_id' is set
        if ($offer_id === null || (is_array($offer_id) && count($offer_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($ebay_offer_details_with_id)) {
            $_tempBody = $ebay_offer_details_with_id;
        }
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayInventoryApi\Model\WithdrawResponse
     */
     ...
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayInventoryApi\Model\WithdrawResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function withdrawOfferWithHttpInfo($offer_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayInventoryApi\Model\WithdrawResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayInventoryApi\Model\WithdrawResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayInventoryApi\Model\WithdrawResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayInventoryApi\Model\WithdrawResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \EbayInventoryApi\Model\WithdrawByInventoryItemGroupRequest $withdraw_by_inventory_item_group_request The base request of the withdrawOfferByInventoryItemGroup call. (required)
     *
     * @throws \EbayInventoryApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function withdrawOfferByInventoryItemGroupRequest($withdraw_by_inventory_item_group_request)
    {
        ...
        if (isset($withdraw_by_inventory_item_group_request)) {
            $_tempBody = $withdraw_by_inventory_item_group_request;
        }
