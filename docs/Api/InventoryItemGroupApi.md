# EbayInventoryApi\InventoryItemGroupApi
...
> \EbayInventoryApi\Model\BaseResponse createOrReplaceInventoryItemGroup($inventory_item_group_key, $content_language, $inventory_item_group)
...
$apiInstance = new EbayInventoryApi\Api\InventoryItemGroupApi(
...
$inventory_item_group = new \EbayInventoryApi\Model\InventoryItemGroup(); // \EbayInventoryApi\Model\InventoryItemGroup | Details of the inventory Item Group
 ...
 **inventory_item_group** | [**\EbayInventoryApi\Model\InventoryItemGroup**](../Model/InventoryItemGroup.md)| Details of the inventory Item Group |
...
> \EbayInventoryApi\Model\InventoryItemGroup getInventoryItemGroup($inventory_item_group_key)
...
[**\EbayInventoryApi\Model\InventoryItemGroup**](../Model/InventoryItemGroup.md)
