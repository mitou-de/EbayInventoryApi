# EbayInventoryApi\InventoryItemApi
...
> \EbayInventoryApi\Model\BulkInventoryItemResponse bulkCreateOrReplaceInventoryItem($bulk_inventory_item)
...
------------- | ------------- | ------------- | -------------
 **bulk_inventory_item** | [**\EbayInventoryApi\Model\BulkInventoryItem**](../Model/BulkInventoryItem.md)| Details of the inventories with sku and locale |

### Return type

[**\EbayInventoryApi\Model\BulkInventoryItemResponse**](../Model/BulkInventoryItemResponse.md)
...
> \EbayInventoryApi\Model\BulkGetInventoryItemResponse bulkGetInventoryItem($bulk_get_inventory_item)
...
$bulk_get_inventory_item = new \EbayInventoryApi\Model\BulkGetInventoryItem(); // \EbayInventoryApi\Model\BulkGetInventoryItem | Details of the inventories with sku and locale
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bulk_get_inventory_item** | [**\EbayInventoryApi\Model\BulkGetInventoryItem**](../Model/BulkGetInventoryItem.md)| Details of the inventories with sku and locale |

### Return type

[**\EbayInventoryApi\Model\BulkGetInventoryItemResponse**](../Model/BulkGetInventoryItemResponse.md)
...
> \EbayInventoryApi\Model\BulkPriceQuantityResponse bulkUpdatePriceQuantity($bulk_price_quantity)
...
$bulk_price_quantity = new \EbayInventoryApi\Model\BulkPriceQuantity(); // \EbayInventoryApi\Model\BulkPriceQuantity | Price and allocation details for the given SKU and Marketplace
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bulk_price_quantity** | [**\EbayInventoryApi\Model\BulkPriceQuantity**](../Model/BulkPriceQuantity.md)| Price and allocation details for the given SKU and Marketplace |

### Return type

[**\EbayInventoryApi\Model\BulkPriceQuantityResponse**](../Model/BulkPriceQuantityResponse.md)
...
> \EbayInventoryApi\Model\BaseResponse createOrReplaceInventoryItem($sku, $content_language, $inventory_item)
...
$inventory_item = new \EbayInventoryApi\Model\InventoryItem(); // \EbayInventoryApi\Model\InventoryItem | Details of the inventory item record.
 ...
 **inventory_item** | [**\EbayInventoryApi\Model\InventoryItem**](../Model/InventoryItem.md)| Details of the inventory item record. |
...
> \EbayInventoryApi\Model\InventoryItemWithSkuLocaleGroupid getInventoryItem($sku)
...
[**\EbayInventoryApi\Model\InventoryItemWithSkuLocaleGroupid**](../Model/InventoryItemWithSkuLocaleGroupid.md)
...
> \EbayInventoryApi\Model\InventoryItems getInventoryItems($limit, $offset)
...
[**\EbayInventoryApi\Model\InventoryItems**](../Model/InventoryItems.md)
