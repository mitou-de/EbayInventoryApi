...
> \EbayInventoryApi\Model\BulkMigrateListingResponse bulkMigrateListing($bulk_migrate_listing)
...
$apiInstance = new EbayInventoryApi\Api\ListingApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$bulk_migrate_listing = new \EbayInventoryApi\Model\BulkMigrateListing(); // \EbayInventoryApi\Model\BulkMigrateListing | Details of the listings that needs to be migrated into Inventory
...
------------- | ------------- | ------------- | -------------
 **bulk_migrate_listing** | [**\EbayInventoryApi\Model\BulkMigrateListing**](../Model/BulkMigrateListing.md)| Details of the listings that needs to be migrated into Inventory |

### Return type

[**\EbayInventoryApi\Model\BulkMigrateListingResponse**](../Model/BulkMigrateListingResponse.md)
